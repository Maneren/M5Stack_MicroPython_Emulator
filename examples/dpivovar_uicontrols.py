...
btn = M5Btn("Play", 15, 15, 50, 30)
ch = M5Checkbox("Checkbox", 15, 50, 50, 30, 0x0288FB, 0xCCCCCC) # text color, check color
switch = M5Switch(15, 85, 70, 30, 0xCCCCCC, 0x0288FB) # bg color, color

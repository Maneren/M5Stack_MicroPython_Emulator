...
class Button_Base {
	...
	public:
		...
		static bool wasPressed() {
			return CM5Stack_VM::Instance()->Get_Buttons()->wasPressed(TChild::Get_Button());
		}

		static void wasPressed(PyObject* obj) {
			CM5Stack_VM::Instance()->Get_Buttons()->wasPressedRegisterCallback(TChild::Get_Button(), obj);
		}

		static bool wasReleased() {
			return CM5Stack_VM::Instance()->Get_Buttons()->wasReleased(TChild::Get_Button());
		}

		static void wasReleased(PyObject* obj) {
			CM5Stack_VM::Instance()->Get_Buttons()->wasReleasedRegisterCallback(TChild::Get_Button(), obj);
		}

		static bool isPressed() {
			return CM5Stack_VM::Instance()->Get_Buttons()->isPressed(TChild::Get_Button());
		}

		static bool isReleased() {
			return CM5Stack_VM::Instance()->Get_Buttons()->isReleased(TChild::Get_Button());
		}
};
...
class ButtonA : public Button_Base<ButtonA> {
	...
	public:
		static CM5Buttons::Button Get_Button() {
			return CM5Buttons::Button::A;
		}
};

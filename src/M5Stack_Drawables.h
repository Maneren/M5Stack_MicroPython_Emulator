...
class CDrawable_Button : public IDrawable {
	...
	public:
		CDrawable_Button(const std::string& text, int x, int y, int width, int height, int textColor = 0x2222EE, int brushColor = 0xFAFAFA);
...
class CDrawable_Checkbox : public IDrawable {
	...
	public:
		CDrawable_Checkbox(const std::string& text, int x, int y, int width, int height, int textColor = 0x2222EE, int checkColor = 0xFAFAFA);
...
class CDrawable_Switch : public IDrawable {
	...
	public:
		CDrawable_Switch(int x, int y, int width, int height, int bgColor = 0xFAFAFA, int switchColor = 0x2222EE);

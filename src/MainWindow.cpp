...
CMain_Window::CMain_Window(const std::filesystem::path& pyFile) : QMainWindow(nullptr), mPy_File_Path(pyFile) {
	//
}
...
void CMain_Window::Setup_GUI() {
	...
	WidgetEventProxy::Instance()->moveToThread(QApplication::instance()->thread());
